...
gcloud compute instances create vm-2 --project=$PROJECT_ID --zone=$ZONE --service-account=$SA --scopes=https://www.googleapis.com/auth/bigquery
...
gcloud compute instances create bigquery-instance --project=$PROJECT_ID --zone=$ZONE --service-account=$SSA --scopes=https://www.googleapis.com/auth/bigquery
